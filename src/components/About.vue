			...
			<div class="container">
				<div class="genre">
					<h1>CTFとは</h1>
						...
						<section>
						<h1>ルール</h1>
						<p>CpawCTFをやる際は、以下のルールに従ってください。</p>
						<ul>
				...
				<div class="genre">
					...
					<section>
						...
						<h2>便利なツール</h2>
						<ul>
							<li>エディタ [Vim, emacs, Sublime Text, VisualStudio Code, atom, ...]</li>
							<li>IDE [VisualStudio, IntelliJ, ...]</li>
							<li>各言語コンパイラ，インタプリタ</li>
						</ul>
					</section>
